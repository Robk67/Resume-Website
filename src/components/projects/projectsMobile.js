        ...
        <div className="col-md-4 projectCard">
          <div className="card-body projectCardBody">
            ...
            <p className="card-text">
              A web application built using the MEAN stack and was hosted using
              Amazon web services. Fouryears is an application that was designed
              to generate school schedules for students, ensuring that they
              would graduate from college in four years.
            </p>
          </div>
          <div className="projectCardFooter">
            <div className="row">
              <div className="col projectSkills">Angular</div>
              <div className="col projectSkills">HTML</div>
              <div className="col projectSkills">CSS</div>
              <div className="col projectSkills">JS</div>
            </div>
          </div>
        </div>
        <div className="col-md-4 projectCard">
        ...
        <div className="col-md-4 projectCard">
          <div className="card-body projectCardBody">
            ...
            <p className="card-text">
              ...
              languages. This app showcased the concepts from computer graphics
              like object collision and a homing missle algorithhm.
            </p>
          </div>
          <div className="projectCardFooter">
            <div className="row">
              <div className="col projectSkills">C/C++</div>
              <div className="col projectSkills">OpenGL</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-md-4 projectCard">
          <div className="card-body projectCardBody">
            ...
            <p className="card-text">
              ...
              3D. This game follows a robot that has to collect emotions and use
              them as power ups to travel through three levels, beat puzzles and
              the defeat the final boss.
            </p>
          </div>
          <div className="projectCardFooter">
            <div className="row">
              <div className="col projectSkills">Unity</div>
              <div className="col projectSkills">C#</div>
            </div>
          </div>
        </div>
        <div className="col-md-4 projectCard">
          <div className="card-body projectCardBody">
            ...
            <p className="card-text">
              ...
              featured pathing algorithms such as the A* algorithm, interactions
          ...
          <div className="projectCardFooter">
            <div className="row">
              <div className="col projectSkills">C#</div>
              <div className="col projectSkills">Monogame</div>
            </div>
          </div>
        </div>
        <div className="col-md-4 projectCard">
          ...
          <div className="projectCardFooter">
            <div className="row">
              <div className="col projectSkills">React</div>
              <div className="col projectSkills">HTML</div>
              <div className="col projectSkills">CSS</div>
              <div className="col projectSkills">JS</div>
            </div>
